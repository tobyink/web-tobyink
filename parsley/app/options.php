...
add_action( 'acf/init', function () {
	...
	$opts->addSelect( 'parsley_header_style', [ 'label' => 'Menu Bar Branding Style', 'wrapper' => [ 'width' => '50%', 'id' => '', 'class' => '' ], 'default_value' => 'text', 'choices' => [ 'text', 'image', 'none' ] ] )->conditional( 'parsley_header_menubar', '==', 1 );
